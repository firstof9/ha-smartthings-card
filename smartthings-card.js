          ...
          <div class="right-panel">
            ${l?F`
                  <div class="temp-row">
                    ...
                    <div class="temp-fg">
                      <span>${l.padStart(3," ")}</span>
                      <span class="temp-unit">${h}</span>
                    </div>
                  </div>
                `:""}
